...
/**
 * This the model of the simple Pong game.
...
public class PongModel {
	...
	//MARCOS
	private ArrayList<PongModelObserver> observers = new ArrayList<PongModelObserver>();
	...
	//MARCOS
	void registerObserver(PongModelObserver o) {
		observers.add(o);
	}
	
	//MARCOS
	void updateObservers() {
		for(PongModelObserver o : observers)
