...
public class PongView extends JFrame {
	...
	public void registerListeners(PongMouseController controller1, 
		...
		//Add mouse listener to the view window, so that the popup menu shows up
		//if the mouse is clicked at any position inside the window
